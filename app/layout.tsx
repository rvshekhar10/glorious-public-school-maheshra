    ...
    <html lang="en" className="scroll-smooth">
      ...
      <body className={`${inter.variable} ${playfair.variable} font-inter antialiased`} suppressHydrationWarning>
        ...
        <a
          ...
          className="fixed bottom-6 left-6 z-50 md:hidden bg-primary hover:bg-primary-dark text-white px-6 py-3 rounded-full shadow-lg transition-all duration-300 hover:scale-105 flex items-center gap-2"
        >
